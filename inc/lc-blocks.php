...
function acf_blocks()
{
    if (function_exists('acf_register_block_type')) {
        ...
        acf_register_block_type(array(
            'name'				=> 'lc_clients_slider',
            'title'				=> __('LC Clients Slider'),
            'category'			=> 'layout',
            'icon'				=> 'cover-image',
            'render_template'	=> 'page-templates/blocks/lc_clients_slider.php',
            'mode'	=> 'edit',
            'supports' => array('mode' => false),
        ));
        acf_register_block_type(array(
            'name'				=> 'lc_clients_grid',
            'title'				=> __('LC Clients Grid'),
            'category'			=> 'layout',
            'icon'				=> 'cover-image',
            'render_template'	=> 'page-templates/blocks/lc_clients_grid.php',
            'mode'	=> 'edit',
            'supports' => array('mode' => false),
        ));
    }
